...
public class JoinOptimizer {
    ...
    public static int estimateTableJoinCardinality(Predicate.Op joinOp,
        ...
        if (joinOp==Predicate.Op.EQUALS){
            ...
            //if both primary key or neither primary key, return the bigger one
        ...
        for (int i=1; i<=n; i++){
            ...
            for (Set<LogicalJoinNode> s : iSubset){
                ...
                for (LogicalJoinNode remove : s){
                    ...
                    CostCard currentPlan = computeCostAndCardOfSubplan(stats, filterSelectivities, remove, s, bestCost, optjoin);

                    if (currentPlan !=null){

                        bestCost = currentPlan.cost;
